...
$outgoingServerAddress      = 'smtp.googlemail.com'; // Consult your hosting provider.
...
$sendingAccountUsername     = 'tamasi@isf.hu';
$sendingAccountPassword     = 'Suth3rl4nd';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'tamasi@isf.hu'; // REQUIRED value.
$recipientName              = 'John Doe';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'Üzenet a weboldalról'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'Setahajo.hu';                // REQUIRED value. This is used when a name or email is not collected from the website form

$timeZone                   = 'Europe/Budapest';         // OPTIONAL, but some servers require this to be set. 
...
$recaptchaErrorMessage      = 'Sajnos nem sikerült. Próbáld újra.';
